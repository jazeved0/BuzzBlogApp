...
class Client(Iface):
    ...
    def list_likes(self, requester_id, query, limit, offset):
        ...
        """
        self.send_list_likes(requester_id, query, limit, offset)
        return self.recv_list_likes()

    def send_list_likes(self, requester_id, query, limit, offset):
...
class Processor(Iface, TProcessor):
    ...
    def process_list_likes(self, seqid, iprot, oprot):
        ...
        result = list_likes_result()
        try:
            result.success = self._handler.list_likes(args.requester_id, args.query, args.limit, args.offset)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
