...
class Client(Iface):
    ...
    def list_posts(self, requester_id, query, limit, offset):
        ...
        """
        self.send_list_posts(requester_id, query, limit, offset)
        return self.recv_list_posts()

    def send_list_posts(self, requester_id, query, limit, offset):
...
class Processor(Iface, TProcessor):
    ...
    def process_list_posts(self, seqid, iprot, oprot):
        ...
        result = list_posts_result()
        try:
            result.success = self._handler.list_posts(args.requester_id, args.query, args.limit, args.offset)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
